...
const { AmbientLight, Object3D, DirectionalLight, PointLight, SpotLight } =
  THREE;
...
export class LightEffect extends BaseObject {
  constructor(options: Object3DOptions, context: Scene) {
    ...
    let intensity = appearance.intensity || 1;
    ...
    let light = new lightConstructors[type](color, intensity);
