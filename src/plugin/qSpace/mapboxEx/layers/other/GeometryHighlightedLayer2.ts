...
class GeometryHighlightedLayer2 {
  map: any;
  obj: any = null;

  sId: string = 'geometry_highlighted_source2';
  lId: string = 'geometry_highlighted_layer2';
  ...
  addLayer(geometry: any, id?: string, obj: any = {}) {
    ...
    if (layer) {
      ...
      clearEventFrame('geometryHighlightedLayerUpdate2');

      // addEventFrame({
      //   name: 'geometryHighlightedLayerUpdate2',
      //   time: 50,
      //   func: (time: number) => {
      //     animateLine(time);
      //   },
...
export default GeometryHighlightedLayer2;
